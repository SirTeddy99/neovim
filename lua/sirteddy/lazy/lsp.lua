return {
    ...
    config = function()
                    ...
                    lspconfig.jsonls.setup({
                        ...
                        settings = {
                            json = {
                                ...
                                format = { enable = false }, -- We use jq for formatting
                            }
                        }
                    })
                end,
        ...
        null_ls.setup({
            ...
            on_attach = function(client, bufnr)
                ...
                vim.api.nvim_create_autocmd("BufWritePre", {
                    ...
                    pattern = { "*.go", "*.json", "*.jsonc", "*.md", "*.tf", "*.sh", "*.lua" }, -- Adjust based on your file types
                    callback = function()
        ...
        -- Format JSONC with prettier on save
        vim.api.nvim_create_autocmd("BufWritePre", {
            group = vim.api.nvim_create_augroup("JsoncFormat", { clear = true }),
            pattern = { "*.jsonc" },
            callback = function()
